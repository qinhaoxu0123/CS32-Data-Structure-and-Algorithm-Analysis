...
//  Project 2
//
//  Created by Qinhao Xu on 1/29/17.
...
void test()
{
    ...
    /*assert(s.insert(0, "lavash"));
    assert(s.insert(0, "nihao"));
     assert(s.insert(0, "hi"));
     assert(s.insert(0, "nihao"));*/
        /*Sequence s1;
    assert(s1.insert(0, "a"));
    assert(s1.insert(0, "b"));
    assert(s1.insert(0, "c"));
    assert(s1.insert(0, "d"));
    s=s1;*/
    //Sequence s1(s);
    /*assert(s.insert("d")==true);
    assert(s.insert("c")==true);
    assert(s.insert("b")==true);
    assert(s.insert("a")==true);*/
    //test for erase function;
    
    //test for erase function
    //assert(s.erase(4)==false);
    
    //test for remove function
     //assert(s.remove("nihao")==2);
    //assert(s.remove("hi")==1);
    
    //test for set function
   /* assert(s.set(0,"a")==true);
    assert(s.set(2,"b")==true);
       assert(s.set(4,"c")==false);*/
    //test for the find function
    //assert(s.find("lavash")==4);
    
    //assert(s1.size() ==1);
    /*ItemType x = "injera";
    assert(s.get(0, x)  &&  x == "a");
    assert(s.get(1, x)  &&  x == "hi");
    assert(s.get(2, x)  &&  x == "b");
    assert(s.get(3, x)  &&  x == "lavash");*/
     //assert(s.get(0, x)  &&  x == "tortilla");
     //assert(s.get(1, x)  &&  x == "lavash");
//}
/*
